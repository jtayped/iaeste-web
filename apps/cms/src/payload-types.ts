...
export interface Config {
  ...
  fallbackLocale: ('false' | 'none' | 'null') | false | null | ('ca' | 'es' | 'en') | ('ca' | 'es' | 'en')[];
  globals: {};
  globalsSelect: {};
  locale: 'ca' | 'es' | 'en';
  widgets: {
...
export interface Post {
  ...
  slug?: string | null;
  /**
   * obligatori per publicar en català, màxim 240 caràcters
   */
  excerpt?: string | null;
  body?: {
    root: {
  ...
  /**
   * només l'utilitza el script de migració
   */
...
export interface Tag {
  id: number;
  /**
   * identificador estable en minúscules, únic
   */
  key: string;
  label: string;
  updatedAt: string;
